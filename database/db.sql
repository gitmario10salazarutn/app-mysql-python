...
alter table rol_user modify column id_rol integer auto_increment;
...
create table language_type(
	id_langtype integer auto_increment not null,
...
create table knowledge_level(
	id_knowledge_level integer auto_increment not null,
...
create table language_learned(
	id_langlearn integer auto_increment not null,
...
alter table language_learned modify column description varchar(500);
